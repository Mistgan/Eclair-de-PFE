...
public class Spaceflight : MonoBehaviour {
	...
	internal float stunned = 1f; //1f means thrust and turn disabled completely, like after collisions. 0f means no reduction.
	...
	void FixedUpdate () {
        //texte.text = "Nombre d'énemis restant: " + Genrate_Enemy.passEnemies;
    ...
    private void OnTriggerEnter(Collider other)
    {
        ...
        {
            //health_player -= 10;
            Debug.Log("tu as foncé dans "+ gameObject.name);
        }
        Degat();
    }
